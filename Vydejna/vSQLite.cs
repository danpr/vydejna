        ...
        public override Int32 addNewLineZmenyAndVracenoAndPujceno(Int32 DBporadi, DateTime DBdatum, Int32 DBks, string DBpoznamka, string DBoldOsCislo, string DBnewOsCislo)
        {
            ...
            if (DBIsOpened())
            {
                ...
                try
                {
                    ...
                    SQLiteCommand cmd1a = new SQLiteCommand(commandString1, myDBConn as SQLiteConnection);
                    ...
                    SQLiteCommand cmd7 = new SQLiteCommand(commandString7, myDBConn as SQLiteConnection);
            ...
            if (DBIsOpened())
            {
                ...
                try
                {
                    ...
                    if (seqReader1.Read() == true)
                    {
                        ...
                        datum = (seqReader1.GetDateTime(seqReader1.GetOrdinal("datum"))).Date;
                    ...
                    SQLiteCommand cmdr4 = new SQLiteCommand(commandStringRead4, myDBConn as SQLiteConnection);
                    ...
                    SQLiteDataReader myReader4 = cmdr4.ExecuteReader();
