...
namespace Vydejna
{
    class StrategiePosKonto : ISestava1
    {
        ...
        {
            e.Graphics.DrawString(Convert.ToString(DataRow["konto"]), tiskFont9, Brushes.Black, new PointF(45, posY));
        ...
        public void printHeader(PrintPageEventArgs e, Int32 posY)
        {
            ...
            e.Graphics.DrawString("Konto", tiskFont9b, Brushes.Black, new PointF(45, posY + 10));
